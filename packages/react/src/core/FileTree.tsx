...
export function FileTree({
  ...
  return (
    <div className={classNames(className, 'h-100% relative transition-theme bg-tk-elements-fileTree-backgroundColor')}>
...
function Folder({ folder: { depth, name, fullPath }, i18n, collapsed, onClick, onFileChange }: FolderProps) {
  return (
    <ContextMenu onFileChange={onFileChange} i18n={i18n} directory={fullPath} style={getDepthStyle(depth)}>
      <NodeButton
